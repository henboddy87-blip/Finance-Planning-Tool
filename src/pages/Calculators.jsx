...
export default function Calculators() {
  ...
  const TABS = [
    { id: "loan", label: t("Loan Calculator"), icon: <Icons.Loan /> },
    { id: "emi", label: t("EMI Calculator"), icon: <Icons.EMI /> },
    { id: "savings", label: t("Savings Growth"), icon: <Icons.Savings /> },
    {
      id: "investment",
      label: t("Investment Return"),
  ...
  const savingsResult = useMemo(
    () =>
      calcSavingsGrowth(
        savingsState.initial || 0,
        savingsState.monthly || 0,
        savingsState.rate || 0,
        savingsState.years || 1,
      ),
    [savingsState],
  );
  const investResult = useMemo(
    () =>
      calcSavingsGrowth(
        investState.initial || 0,
        investState.monthly || 0,
        investState.rate || 0,
        investState.years || 1,
      ),
    [investState],
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 animate-fadeIn">
      <PageHeader
        ...
        subtitle={t("Plan your loans, investments, and savings with precision")}
      />
              ...
              <>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      type="number"
                      className="w-full px-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-gray-200 focus:outline-none focus:border-emerald-500 transition-colors"
                ...
                <>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm min-w-0">
                      <div className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-500 mb-1 truncate">
                        Monthly Payment
                      </div>
                      <div
                        className="text-xl lg:text-2xl xl:text-3xl font-bold text-emerald-600 dark:text-emerald-400 truncate"
                        title={fmtFull(result.payment || 0)}
                      >
                        {fmtFull(result.payment || 0)}
                      </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm min-w-0">
                      <div className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-500 mb-1 truncate">
                      ...
                      <div
                        className="text-xl lg:text-2xl xl:text-3xl font-bold text-amber-600 dark:text-amber-400 truncate"
                        title={fmtFull(result.totalInterest || 0)}
                      >
                        {fmtFull(result.totalInterest || 0)}
                      </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm min-w-0">
                      <div className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-500 mb-1 truncate">
                      ...
                      <div
                        className="text-xl lg:text-2xl xl:text-3xl font-bold text-gray-900 dark:text-white truncate"
                        title={fmtFull(
                          (state.amount || 0) + (result.totalInterest || 0),
                        )}
                      >
                        {fmtFull(
                          (state.amount || 0) + (result.totalInterest || 0),
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
                      ...
                      <div className="text-2xl font-bold text-gray-900 dark:text-white">
                        {fmtFull(result.totalInvested || 0)}
                      </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
                      <div className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-500 mb-1">
