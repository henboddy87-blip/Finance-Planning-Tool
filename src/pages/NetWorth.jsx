...
export default function NetWorth() {
  ...
  const [liabilities, setLiabilities] = useLocalStorage(
    "wp_liabilities",
    initialLiabilities,
  );
  ...
  const assetsByCategory = assetCats
    .map((cat) => ({
      name: cat,
      value: assets
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 animate-fadeIn">
      <PageHeader
        title={t("Net Worth")}
        subtitle={t("Your complete financial balance sheet")}
        actions={
          <div className="flex gap-3">
            <button
              ...
              onClick={() => {
                setShowAdd("asset");
                setForm({ name: "", category: assetCats[0], value: "" });
              }}
            >
              + {t("Asset")}
            </button>
            <button
              ...
              onClick={() => {
                setShowAdd("liability");
                setForm({ name: "", category: liabCats[0], value: "" });
              }}
            >
              + {t("Liability")}
            </button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-900/5 backdrop-blur-sm rounded-xl border border-emerald-200 dark:border-emerald-500/30 p-5 transition-all hover:scale-[1.02] duration-200">
          <div className="text-xs font-semibold uppercase tracking-wider text-emerald-600 dark:text-gray-400 mb-2">
            Net Worth
          </div>
          <div className="text-2xl md:text-3xl font-bold text-emerald-700 dark:text-emerald-400">
            {fmt(netWorth)}
          </div>
          <div className="text-xs text-emerald-600/70 dark:text-gray-500 mt-2 flex items-center gap-1">
            <ArrowUp className="w-3 h-3" /> {fmt(36800)} this year
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    showAdd === "asset" ? "Ex. Savings Account" : "Ex. Car Loan"
                  }
                  value={form.name}
                  onChange={(e) =>
              ...
              <div>
                ...
                >
                  {(showAdd === "asset" ? assetCats : liabCats).map((c) => (
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-900/50">
                <tr className="border-b border-gray-200 dark:border-gray-700">
                  ...
                  <th className="text-right p-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    Value
                  </th>
                    ...
                    <td className="p-4 text-center">
                      <button
                        onClick={() => {
                          ...
                          toast.success("Deleted", "Asset removed.");
                        }}
                    ...
                    <td className="p-4 text-center">
                      <button
                        onClick={() => {
                          ...
                          toast.success("Deleted", "Liability removed.");
                        }}
                        className="text-gray-400 hover:text-rose-500 dark:text-gray-500 dark:hover:text-rose-400 transition-colors"
                      >
                        <X className="w-4 h-4" />
