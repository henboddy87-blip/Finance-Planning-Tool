...
function generatePayoff(balance, rate, payment, months = 60) {
  ...
  for (
    let i = 0;
    i <= Math.min(months, payoffMonths(balance, rate, payment));
    i++
  ) {
...
export default function DebtManager() {
  ...
  const selectedDebt = selected
    ? debts.find((d) => d.id === selected)
    : debts[0];
  const payoffData = selectedDebt
    ? generatePayoff(
        selectedDebt.balance,
        selectedDebt.rate,
        selectedDebt.payment,
      )
    : [];
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 animate-fadeIn">
      <PageHeader
        title={t("Debt Manager")}
        subtitle={t("Track and accelerate your debt payoff journey")}
        actions={
          <button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          label="Extra Payment"
          value={fmt(totalPayment - totalMinPayment)}
          sub="above minimum"
          color="emerald"
        />
      </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, minPayment: e.target.value }))
                  }
                />
              </div>
              <div className="col-span-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <div
            className={`text-xs text-gray-600 dark:text-gray-400 mb-4 p-2 rounded-lg ${
              strategy === "avalanche"
          ...
          >
            {strategy === "avalanche" ? (
              <div className="flex items-center gap-2">
                <Icons.Fire /> Avalanche: Pay highest interest first — saves the
                most money overall
              </div>
            ) : (
              <div className="flex items-center gap-2">
                <Icons.Snowflake /> Snowball: Pay smallest balance first —
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-1.5 py-0.5 text-xs rounded-full bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400">
                        {debt.rate}%
                      </span>
                    </div>
                  ...
                  <div className="h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(100, (1 - debt.balance / (debt.balance * 1.2)) * 100 + 15)}%`,
        ...
        {/* Payoff chart */}
        <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          <div className="text-sm font-semibold text-gray-900 dark:text-gray-200 mb-1">
            Payoff Projection
          </div>
          {selectedDebt && (
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
              <div className="p-2 bg-gray-100 dark:bg-gray-900 rounded-lg">
                ...
                <div className="text-sm font-semibold text-rose-600 dark:text-rose-400">
                  {fmtFull(
                    (selectedDebt.balance * selectedDebt.rate) / 100 / 12,
                  )}
                </div>
              </div>
              <div className="p-2 bg-gray-100 dark:bg-gray-900 rounded-lg">
