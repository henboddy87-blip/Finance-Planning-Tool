...
const transactions = [
  ...
  { desc: "Mortgage Payment", cat: "Housing", date: "Apr 25", amount: 1850.0 },
  { desc: "CVS Pharmacy", cat: "Healthcare", date: "Apr 24", amount: 34.5 },
  ...
  {
    desc: "Restaurant Le Bistro",
    cat: "Food & Dining",
    date: "Apr 20",
    amount: 78.6,
  },
  { desc: "Gym Membership", cat: "Healthcare", date: "Apr 19", amount: 49.0 },
];
...
export default function BudgetPlanner() {
  ...
  const handleAddCat = () => {
    if (!newCat.name || !newCat.budgeted) {
      toast.error(
        "Validation Error",
        "Please enter a category name and budget amount.",
      );
      return;
    }
    setCategories((prev) => [
    ...
    toast.success(
      "Category Added",
      `"${newCat.name}" budget category has been created.`,
    );
  };
  ...
  const handleEditSave = (id) => {
    ...
    setCategories((prev) =>
      prev.map((c) =>
        c.id === id ? { ...c, budgeted: parseFloat(editVal) || c.budgeted } : c,
      ),
    );
    setEditId(null);
    toast.success(
      "Budget Updated",
      `"${cat?.name}" budget set to $${parseFloat(editVal).toLocaleString()}.`,
    );
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 animate-fadeIn">
      <PageHeader
        ...
        subtitle={t("Track and manage your monthly spending")}
        actions={
          <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewCat((p) => ({ ...p, budgeted: e.target.value }))
                  }
                />
              </div>
                ...
                <div key={cat.id}>
                  ...
                  <div className="h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${pct}%`,
                        background: over ? "#f43f5e" : cat.color,
                      }}
                    />
                  </div>
                </div>
            ...
            <tbody>
              {transactions.map((tx, i) => (
                ...
                >
                  ...
                  <td className="p-4 text-right text-sm font-semibold text-rose-600 dark:text-rose-400">
                    -{fmtFull(tx.amount)}
                  </td>
                </tr>
              ))}
