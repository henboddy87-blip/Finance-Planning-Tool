...
const connectedAccounts = [
  ...
  },
  {
    ...
    status: "active",
    synced: "2 min ago",
    logo: "https://play-lh.googleusercontent.com/neBoLmWSd3k5JBQhlM8GBFfREecG2ZZyZfao5zgr0koHOQvZL_HZkX_9LkkXABUmBK4",
    color: "#b91d22",
  },
  {
    id: 3,
    ...
    status: "active",
    synced: "5 min ago",
    logo: "https://cccbic.org/businesses/430-logo.jpg",
    color: "#00478f",
  },
  {
    id: 4,
    ...
    status: "active",
    synced: "15 min ago",
    logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMTnHfaEfTex5H6zVSUHv0SeW6NYrd3RsYlg&s",
    color: "#a0cd4a",
  },
  {
    id: 5,
...
const availableWallets = [
  {
    name: "Apple Pay",
    logo: "https://img.icons8.com/external-tal-revivo-color-tal-revivo/1200/external-apple-pay-a-mobile-payment-and-digital-wallet-service-by-apple-logo-color-tal-revivo.jpg",
    users: "1.5M+",
  },
  {
    name: "Google Pay",
    logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR4ArUxtci1ip0bL0K9hs9QtwcJGy_gu9iYA&s",
    users: "900K+",
  },
  {
    name: "PayPal",
    logo: "https://thumbs.dreamstime.com/b/paypal-logo-printed-paper-chisinau-moldova-september-internet-based-digital-money-transfer-service-128373487.jpg",
    users: "1.2M+",
  },
  {
    name: "Venmo",
    logo: "https://play-lh.googleusercontent.com/YAKMX5YFcuE8_NogkbM7gkqrhBY6CUefbpULAVnNZLSitbo9S3Dw2FIYNqhW0d5G94Y",
    users: "880K+",
  },
  {
    name: "Zelle",
    logo: "https://www.citypng.com/public/uploads/preview/zelle-round-logo-icon-png-701751694968675lxmjumweha.png?v=2026040403",
    users: "600K+",
  },
  {
    name: "Cash App",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Square_Cash_app_logo.svg/960px-Square_Cash_app_logo.svg.png",
    users: "700K+",
  },
];
...
const wallets = [
  {
    name: "Apple Pay",
    icon: "https://img.icons8.com/external-tal-revivo-color-tal-revivo/1200/external-apple-pay-a-mobile-payment-and-digital-wallet-service-by-apple-logo-color-tal-revivo.jpg",
    status: "connected",
    balance: 240.0,
  },
  {
    name: "Google Pay",
    icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQR4ArUxtci1ip0bL0K9hs9QtwcJGy_gu9iYA&s",
    status: "connected",
    balance: 85.5,
  },
  {
    name: "PayPal",
    icon: "https://thumbs.dreamstime.com/b/paypal-logo-printed-paper-chisinau-moldova-september-internet-based-digital-money-transfer-service-128373487.jpg",
    status: "connected",
    balance: 1240.32,
  },
  {
  ...
  {
    name: "Zelle",
    icon: "https://www.citypng.com/public/uploads/preview/zelle-round-logo-icon-png-701751694968675lxmjumweha.png?v=2026040403",
    status: "connected",
    balance: 0,
  },
];
...
export default function BankIntegration() {
  ...
  const filteredList =
    connectType === "bank"
      ...
      : availableWallets.filter((w) =>
          w.name.toLowerCase().includes(searchBank.toLowerCase()),
        );
  const txCategories = ["All", ...new Set(txState.map((t) => t.cat))];
  const filteredTx =
    txFilter === "All" ? txState : txState.filter((t) => t.cat === txFilter);
  ...
  const handleConnect = (name) => {
    ...
    setTimeout(() => {
      ...
      const actualBalance = isNaN(balanceVal)
  ...
  const handleSyncAcc = (acc) => {
    toast.success(
      "Sync Started",
      `Pulling latest transactions for ${acc.bank}...`,
    );
    setTimeout(() => {
      ...
      setAccounts((prev) =>
        prev.map((a) => (a.id === acc.id ? { ...a, synced: nowStr } : a)),
      );
      if (detailsAcc?.id === acc.id)
        setDetailsAcc((prev) => ({ ...prev, synced: nowStr }));
  ...
  const handleWalletManage = (wallet) => {
    if (wallet.status === "connected") {
      setWalletState((prev) =>
        prev.map((w) =>
          w.name === wallet.name
            ? { ...w, status: "disconnected", balance: 0 }
            : w,
        ),
      );
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8 animate-fadeIn">
      <PageHeader
        title={t("Bank & Payment Integration")}
        subtitle={t(
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          sub={`${walletState.filter((w) => w.status === "connected").length} connected`}
          color="amber"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 max-w-lg w-full max-h-[85vh] flex flex-col animate-fadeIn shadow-2xl">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                  Connect {connectType === "bank" ? "Account" : "Wallet"}
                </h3>
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
                  Secured via 256-bit encryption · Read-only access
                </p>
              </div>
              <button
                onClick={() => {
            ...
            <div className="flex gap-2 mb-4 flex-wrap">
              {[
                ...
                <span
                  key={i}
                  className="px-2 py-1 text-xs rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 flex items-center gap-1"
                >
                  {b.icon} {b.text}
                </span>
              ))}
            ...
            {!selectedBank ? (
              ...
              <div className="flex-1 flex flex-col items-center justify-center py-4">
                <img
                  ...
                  referrerPolicy="no-referrer"
                  className="w-16 h-16 rounded-full bg-white object-contain mb-4 shadow-sm border border-gray-200 dark:border-gray-700"
                />
                ...
                <div className="flex gap-3 w-full max-w-sm">
                  <button
                    ...
                    className="flex-1 py-2.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium rounded-lg transition-all"
                    disabled={connecting !== null}
                  >
                    Back
                  </button>
                  <button
                    onClick={() => handleConnect(selectedBank.name)}
                    className="flex-1 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition-all flex items-center justify-center gap-2"
                    disabled={connecting !== null}
                  >
                    {connecting ? (
        ...
        <div>
          ...
          <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-5">
            <div className="flex justify-between items-center mb-4 flex-wrap gap-3">
              <div>
                <div className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-500 mb-1">
                  Account Balance History
                </div>
                <div className="text-sm text-gray-500 dark:text-gray-500">
                  Real-time balance tracking across connected accounts
                </div>
              </div>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <AreaChart data={balanceHistory}>
                ...
                <XAxis
                  ...
                  axisLine={false}
                  tickLine={false}
                  className="dark:[&_tspan]:fill-gray-500"
                />
                <YAxis
                  tick={{ fill: "#6b7280", fontSize: 11 }}
                  axisLine={false}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {accounts.map((acc) => (
              ...
              >
                <div
                  className={`absolute top-0 left-0 w-1 h-full ${acc.balance < 0 ? "bg-rose-500" : "bg-emerald-500"}`}
                />
                <div>
                  ...
                  <div className="flex justify-between items-end mt-2">
                    <div>
                      ...
                      <div
                        className={`text-2xl font-bold ${acc.balance < 0 ? "text-rose-600 dark:text-rose-400" : "text-emerald-600 dark:text-emerald-400"}`}
                      >
                        {acc.balance < 0 ? "-" : ""}
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      onClick={() => handleSyncAcc(acc)}
                      className="flex-1 px-2 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-all flex items-center justify-center gap-1"
                    >
                      <Icons.Sync /> Sync
                    </button>
                    <button
                      onClick={() => setDetailsAcc(acc)}
                      className="flex-1 px-2 py-1.5 text-xs font-medium bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-all flex items-center justify-center gap-1"
                    >
                    ...
                    <button
                      ...
                      className="px-2 py-1.5 text-xs font-medium bg-rose-100 dark:bg-rose-900/30 hover:bg-rose-200 dark:hover:bg-rose-900/50 text-rose-700 dark:text-rose-400 rounded-lg transition-all"
                    >
                      <Icons.Unlink />
                    </button>
                  </div>
            ...
            >
              <div className="text-3xl text-gray-400 dark:text-gray-600 mb-2">
                +
              </div>
              <div className="text-sm text-gray-500 dark:text-gray-500">
                Connect new account
        ...
        <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
            <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5">
              <div className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-500 mb-3">
                Sync Activity (This Week)
              </div>
            ...
            <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5">
              ...
              <div className="space-y-3">
                {[
                  {
                    label: "Transactions synced today",
                    value: "41",
              ...
              <button
                ...
                className="w-full mt-4 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded-lg transition-all flex items-center justify-center gap-2"
              >
              ...
              <table className="w-full">
                <thead className="bg-gray-50 dark:bg-gray-900/50">
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <th className="text-left p-4 text-xs font-semibold text-gray-500 dark:text-gray-500 uppercase">
                      Description
                    </th>
                    <th className="text-left p-4 text-xs font-semibold text-gray-500 dark:text-gray-500 uppercase">
                      Bank
                    ...
                    <th className="text-right p-4 text-xs font-semibold text-gray-500 dark:text-gray-500 uppercase">
                      Amount
                    </th>
                ...
                <tbody>
                  {filteredTx.map((tx, i) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                        {tx.synced ? (
                          <span className="px-2 py-0.5 text-xs rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 flex items-center gap-1 w-fit">
                      ...
                      <td
                        className={`p-4 text-right text-sm font-semibold ${tx.amount > 0 ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`}
                      >
                        {tx.amount > 0 ? "+" : ""}
                        {fmtFull(tx.amount)}
                      </td>
                      <td className="p-4 text-right">
                        <button
                          onClick={() => {
                            setTxState((p) => p.filter((_, idx) => idx !== i));
                            toast.info(
                              "Transaction Deleted",
                              "Record removed.",
                            );
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-5">
            {walletState.map((w, i) => (
              <div
                key={i}
                className="relative bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 hover:border-gray-300 dark:hover:border-gray-600 transition-all hover:scale-[1.02] duration-200"
              >
                <div
                  className={`absolute top-0 left-0 w-1 h-full ${w.status === "connected" ? "bg-emerald-500" : "bg-gray-400 dark:bg-gray-600"}`}
                />
                <div>
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span
                      className={`px-2 py-0.5 text-xs rounded-full ${w.status === "connected" ? "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400" : "bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-500"}`}
                    >
                      {w.status === "connected"
                        ? "● Connected"
                        : "○ Disconnected"}
                  ...
                  <button
                    onClick={() => handleWalletManage(w)}
                    className={`w-full py-2 text-sm font-medium rounded-lg transition-all ${w.status === "connected" ? "bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300" : "bg-emerald-600 hover:bg-emerald-700 text-white"}`}
                  >
            ...
            <div
              ...
              className="bg-gray-50 dark:bg-gray-800/50 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700 hover:border-emerald-500 transition-all cursor-pointer flex flex-col items-center justify-center min-h-[160px]"
            >
              <div className="text-2xl text-gray-400 dark:text-gray-600 mb-2">
                +
              </div>
              <div className="text-sm text-gray-500 dark:text-gray-500">
                Add wallet
            ...
            <div className="flex gap-3 items-start">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-500 mb-3">
                  All wallet connections use OAuth 2.0 and read-only API access.
                  Your credentials are never stored. Transactions are encrypted
                  using AES-256 and synced in real-time via secure webhooks.
                </div>
                <div className="flex gap-2 flex-wrap">
                  {[
                    ...
                    <span
                      key={i}
                      className="px-2 py-0.5 text-xs rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 flex items-center gap-1"
                    >
                      <Icons.Lock /> {b}
                    </span>
                  ))}
      ...
      {activeTab === "settings" && (
        <div className="max-w-2xl">
          <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-5">
            <div className="text-sm font-semibold text-gray-900 dark:text-gray-200 pb-3 border-b border-gray-200 dark:border-gray-700 mb-4">
              Sync Settings
            </div>
            <div className="space-y-3">
              {[
                {
                  ...
                  sub: "Automatically sync every 60 minutes",
                  state: autoSync,
                  setter: setAutoSync,
                },
                {
                  label: "Real-time balance updates",
                  sub: "Push updates on every transaction (may increase API usage)",
                  state: realTime,
                  setter: setRealTime,
                },
              ].map((row, ri) => (
                <div
                  key={ri}
                  className="flex justify-between items-center py-3 border-b border-gray-100 dark:border-gray-700/50 last:border-0"
                >
                  <div>
                  ...
                  <div
                    onClick={() => row.setter((p) => !p)}
                    className={`w-10 h-5 rounded-full cursor-pointer transition-all ${row.state ? "bg-emerald-500" : "bg-gray-300 dark:bg-gray-600"}`}
                  >
                    <div
                      className={`w-4 h-4 rounded-full bg-white transition-all mt-0.5 ${row.state ? "ml-5" : "ml-0.5"}`}
                    />
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-5 mb-5">
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  label: "Delete synced transactions",
                  btn: "Delete All",
                  variant: "danger",
                  act: () =>
                    toast.info("Transactions Cleared", "Local cache emptied."),
                },
                {
                  label: "Revoke all bank access",
                  btn: "Revoke",
                  variant: "danger",
                  act: () =>
                    toast.info("Access Revoked", "All OAuth tokens deleted."),
                },
              ].map((item, i) => (
                <div
                  key={i}
            ...
            <div className="flex gap-3 items-start">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-500">
                  Bank connections are secured through Plaid, trusted by
                  millions. WealthPath only receives read-only access to your
                  transaction data and balances. We never see your credentials.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 max-w-md w-full animate-fadeIn shadow-2xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-500">
                    {detailsAcc.type} ···· {detailsAcc.last4}
                  </p>
                </div>
              </div>
              <button
                onClick={() => setDetailsAcc(null)}
                className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
              >
                <Icons.Close />
              </button>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 flex justify-between items-center">
                ...
                <span
                  className={`text-xl font-bold ${detailsAcc.balance < 0 ? "text-rose-600 dark:text-rose-400" : "text-emerald-600 dark:text-emerald-400"}`}
                >
                  {detailsAcc.balance < 0 ? "-" : ""}
                  {fmtFull(Math.abs(detailsAcc.balance))}
                </span>
              </div>
            ...
            <div className="mt-6 flex gap-3">
              <button
                onClick={() => {
                  handleSyncAcc(detailsAcc);
                  setDetailsAcc(null);
                }}
                className="flex-1 py-2 text-sm font-medium bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-all flex items-center justify-center gap-2"
              >
